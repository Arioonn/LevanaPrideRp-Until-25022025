...
function LoadActor()
{
	...
	if(rows)
	{
	    for(new i; i < rows; i++)
	    {
	        ...
	        ActorData[aid][actorID] = CreateDynamicActor(ActorData[aid][actorSkin], ActorData[aid][actorX], ActorData[aid][actorY], ActorData[aid][actorZ], ActorData[aid][actorR], 1, 100.0, ActorData[aid][actorWorld], ActorData[aid][actorInt], -1, 20.0);
...
CMD:createactor(playerid, params[])
{
	...
	ActorData[tid][actorID] = CreateDynamicActor(ActorData[tid][actorSkin], ActorData[tid][actorX], ActorData[tid][actorY], ActorData[tid][actorZ], ActorData[tid][actorR], 1, 100.0, ActorData[tid][actorWorld], ActorData[tid][actorInt], -1, 20.0);
...
CMD:editactor(playerid, params[])
{
	...
	{			
	    ...
	    ActorData[id][actorID] = CreateDynamicActor(ActorData[id][actorSkin], ActorData[id][actorX], ActorData[id][actorY], ActorData[id][actorZ], ActorData[id][actorR], 1, 100.0, ActorData[id][actorWorld], ActorData[id][actorInt], -1, 20.0);
