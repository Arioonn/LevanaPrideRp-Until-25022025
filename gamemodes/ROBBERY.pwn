...
CMD:chopvehicle(playerid, params[]) 
{
    ...
    if(AdminVehicle{vehid2} || pvData[vehid2][cRent] != 0 || IsASweeperVeh(vehid2) || IsABusVeh(vehid2) || IsAForVeh(vehid2) || IsAMowerVeh(vehid2) || IsABaggageVeh(vehid2) || IsADmvVeh(vehid2) || IsGovCar(vehid2) || IsSANACar(vehid2))
    {
