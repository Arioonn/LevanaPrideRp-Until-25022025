...
CreateJoinMechPoint()
{
	//JOBS
	new strings[128];
	CreateDynamicPickup(1239, 23, 2281.08, -2365.03, 13.8469, -1, -1, -1, 50);
	format(strings, sizeof(strings), "[MECH JOBS]\n{ffffff}Jadilah Pekerja Mekanik disini\n{7fff00}/getjob /accept job");
	CreateDynamic3DTextLabel(strings, COLOR_YELLOW, 2281.08, -2365.03, 13.8469, 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1); // Taxi
}
