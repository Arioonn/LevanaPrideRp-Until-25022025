...
CMD:trackpacket(playerid)
{
    ...
    if(pData[playerid][pJobTime] > 0) return Error(playerid, "Anda harus menunggu "GREY2_E"%d "WHITE_E"detik untuk bisa smuggler kembali.", pData[playerid][pJobTime]);
