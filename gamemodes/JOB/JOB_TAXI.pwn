...
CreateJoinTaxiPoint()
{
	//JOBS
	new strings[128];
	CreateDynamicPickup(1239, 23, 1685.35, -1464.57, 13.9719, -1, -1, -1, 50);
	format(strings, sizeof(strings), "[TAXI JOBS]\n{ffffff}Jadilah Pekerja Taxi disini\n{7fff00}/getjob /accept job");
	CreateDynamic3DTextLabel(strings, COLOR_YELLOW,  1685.35, -1464.57, 13.9719, 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1); // Taxi
}
